...
VALUES (21,1, '3 piece suit one button business wedding suits','File not found','Salvatore','PR12020','NEW','SN1',500,21,22);
INSERT INTO Product (ID, VERSION,DESCRIPTION,FILE,NAME,PRODUCT_NUMBER,PRODUCT_STATUS,SERIAL_NUMBER,UNIT_PRICE,PRODUCT_CATEGORY_ID,SELLER_ID)
VALUES (22,1, 'Samsung Galaxy Smartphone with both cameras','File not found','Samsung G7','SR12020','AVAILABLE','SN2',200,26,22);
INSERT INTO Product (ID, VERSION,DESCRIPTION,FILE,NAME,PRODUCT_NUMBER,PRODUCT_STATUS,SERIAL_NUMBER,UNIT_PRICE,PRODUCT_CATEGORY_ID,SELLER_ID)
VALUES (23,1, 'Dell Laptop with webcam','File not found','Dell Lattitude','DR12020','AVAILABLE','SN3',600,25,22);
INSERT INTO Product (ID, VERSION,DESCRIPTION,FILE,NAME,PRODUCT_NUMBER,PRODUCT_STATUS,SERIAL_NUMBER,UNIT_PRICE,PRODUCT_CATEGORY_ID,SELLER_ID)
VALUES (24,1, 'Shorts for gentlemen','File not found','Office Suits','CR12020','NEW','SN4',800,24,22);
INSERT INTO Product (ID, VERSION,DESCRIPTION,FILE,NAME,PRODUCT_NUMBER,PRODUCT_STATUS,SERIAL_NUMBER,UNIT_PRICE,PRODUCT_CATEGORY_ID,SELLER_ID)
VALUES (25,1, 'Sneakers for running and jogging','File not found','Addidas Fast Sneakers','AR12020','AVAILABLE','SN5',900,23,22);
INSERT INTO Product (ID, VERSION,DESCRIPTION,FILE,NAME,PRODUCT_NUMBER,PRODUCT_STATUS,SERIAL_NUMBER,UNIT_PRICE,PRODUCT_CATEGORY_ID,SELLER_ID)
VALUES (26,1, 'Refrigulators for multipurpose use','File not found','Samsung LP001','LP001','AVAILABLE','SN6',400,23,22);
INSERT INTO Product (ID, VERSION,DESCRIPTION,FILE,NAME,PRODUCT_NUMBER,PRODUCT_STATUS,SERIAL_NUMBER,UNIT_PRICE,PRODUCT_CATEGORY_ID,SELLER_ID)
VALUES (27,1, 'Dell Laptop with webcam','File not found','Dell Lattitude','PR12020','AVAILABLE','SN7',600,25,22);